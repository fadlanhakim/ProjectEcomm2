                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url('register/registrasi/index') ?>" class="user">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?php echo base_url('login/auth/login') ?>">Sudah Punya Akun? Silahkan Login</a>
                            </div>
                        </div>
                    </div>
                </div>
