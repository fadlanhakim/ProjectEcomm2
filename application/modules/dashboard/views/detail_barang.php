    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php foreach ($barang as $brg) : ?>
                <div class="row">
                    <div class="col-md-4">
                        <img src="<?php echo base_url() . '/uploads/' . $brg->gambar  ?> " class="
                        card-img-top">
                    </div>
                    <div class="col-md-8">
                        <table class="table">
                            <tr>
                                <td>Nama Produk</td>
                                <td><strong><?php echo $brg->nama_brg
                                            ?></strong></td>
                            </tr>
                            ...
                            <tr>
                                <td>Kategori</td>
                                <td><strong><?php echo $brg->kategori
                                            ?></strong></td>
                            </tr>
                        ...
                        <?php echo anchor('dashboard/index/' . $brg->id_brg, '<div class="btn btn-sm btn-danger"
                        >Kembali</div>') ?>
