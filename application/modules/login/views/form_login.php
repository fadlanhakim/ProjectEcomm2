                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form method="post" action="<?php echo base_url('login/auth/login') ?>" class="user">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url('register/registrasi/index') ?>">Belum Punya Akun Daftar Disini</a>
                                    </div>
                                </div>
                            </div>
                        </div>
